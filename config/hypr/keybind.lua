...
local KEY = {
	...
	WORKSPACE = ("%s + TAB"):format(mainMod),
	LAUNCHER = ("%s + R"):format(mainMod),
	...
	CONTROL_CENTER = ("%s + N"):format(mainMod),

	CLOSE = ("%s + Q"):format(mainMod),
	FLOAT = ("%s + W"):format(mainMod),
	FULLSCREEN = ("%s + F"):format(mainMod),

	WORKSPACE_NEXT_MONITOR = ("%s + CTRL + tab"):format(mainMod),
...
hl.bind(KEY.VIDEO, hl.dsp.exec_cmd(VIDEO), { description = "Video player" })
...
hl.bind(KEY.CHEATSHEET_TOGGLE, hl.dsp.exec_cmd("noctalia msg panel-toggle kenn/keybind-cheatsheet:cheatsheet"), { description = "Toggle cheatsheet" })
hl.bind(KEY.CONTROL_CENTER, hl.dsp.exec_cmd("noctalia msg panel-toggle control-center"), { description = "Toggle control center" })
...
-- 5. Screenshots
hl.bind("SUPER + PRINT", hl.dsp.exec_cmd("HYPRSHOT_DIR=~/Pictures/Screenshots hyprshot -m window"), { description = "Screenshot window" })
...
hl.bind("SUPER + A", hl.dsp.exec_cmd(SATTY), { description = "Screenshot Annotate" })
...
hl.bind(KEY.WORKSPACE, hl.dsp.exec_cmd(WORKSPACE), { description = "Workspace tabbing" })

-- 8. Move Window Across Workspaces
...
-- 11. Media
hl.bind("XF86AudioPlay",         hl.dsp.exec_cmd("noctalia msg media toggle"),               { locked = true, description = "Play or pause" })
...
hl.bind("XF86AudioRaiseVolume",  hl.dsp.exec_cmd("noctalia msg volume-up 5%"),                { locked = true, description = "Volume up" })
hl.bind("XF86AudioLowerVolume",  hl.dsp.exec_cmd("noctalia msg volume-down 5%"),              { locked = true, description = "Volume down" })
hl.bind("XF86AudioMute",         hl.dsp.exec_cmd("noctalia msg volume-mute"),                 { locked = true, description = "Mute speaker" })
hl.bind("XF86AudioMicMute",      hl.dsp.exec_cmd("noctalia msg mic-mute"),                    { locked = true, description = "Mute microphone" })
hl.bind("XF86MonBrightnessDown", hl.dsp.exec_cmd("noctalia msg brightness-down"),              { locked = true, description = "Brightness down" })
hl.bind("XF86MonBrightnessUp",   hl.dsp.exec_cmd("noctalia msg brightness-up"),                { locked = true, description = "Brightness up" })
